...
!OSI:
      ...
      Camada 7: Application (Aplicação)  (HTPP, FTP, SMTP) => A camada de aplicação (Application - 7) engloba tudo aquilo que faz interação com o usuário final. Ela funciona como uma interface permitindo a comunicação de dados na rede. Quando acessamos um site como o blog da Alura, ou enviamos um e-mail, utilizamos protocolos como o HTTP para acesso de sites e SMTP para o envio de e-mails. Esses protocolos estão presentes na camada de aplicação.
      ...
      "Pois diga novamente tudo sobre o Pedro e a Amanda"
